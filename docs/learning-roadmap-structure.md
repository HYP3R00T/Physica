...
These are conceptual guidelines. They do not introduce new metadata fields or replace the current segment scope labels. The current file format and authoring workflow are documented in [Writing the physics roadmap](roadmap.md).
